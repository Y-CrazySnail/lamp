...
@Service
public class AladdinMemberServiceImpl extends ServiceImpl<MemberMapper, MemberDo> implements IAladdinMemberService {
    ...
    @Override
    public IPage<MemberDo> pages(int current, int size, String email, String wechat) {
        QueryWrapper<MemberDo> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq(BaseEntity.BaseField.DELETE_FLAG.getName(), Constant.FALSE_NUMBER);
