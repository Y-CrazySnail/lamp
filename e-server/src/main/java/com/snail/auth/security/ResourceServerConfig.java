...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/car-file-technician/save",
                        "/car-file-technician/update",
                        "/car-file-technician/delete",
                        "/car-file-technician/pages",
                        "/car-file-technician/getById",
                        "/car-file-technician/list",
                        "/car-file-store/save",
                        "/car-file-store/update",
                        "/car-file-store/delete",
                        "/car-file-store/pages",
                        "/car-file-store/getById",
                        "/car-file-store/list",
                        "/car-file-store/distance",
                        "/car-file-quality/save",
